...
@section('content-header', 'Designer')

@section('content')
    <div class="box">
        <div class="box-header with-border">
            <a href="{{ route('admin.designer.create') }}" class="btn btn-xs btn-primary">Add New</a>
        </div>
        <div class="box-body">
            <table id="designer-table" class="table dt-responsive nowrap" cellspacing="0"  width="100%">
                <thead>
                    <tr>
                        <th>Name</th>
                        <th>Actions</th>
...
@push('post-scripts')
<script>
    var table = new DataTables("#designer-table", {
        ajax: laroute.route('admin.designer.index'),
        columns: [
            { data: 'name', name: 'name' },
