...
@section('title', 'Edit Cover Page')
@section('content-header', 'Edit Cover Page')

@section('content')
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin.cover-page.update', ['id' => $coverPage->id]) }}" method="POST" class="form-horizontal">
