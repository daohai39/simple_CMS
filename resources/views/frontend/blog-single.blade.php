...
<body>
				...
				<header class="site-header">
					<div id="main-header" class="main-header header-sticky">
						<div class="inner-header clearfix">
							<div class="logo">
								<a href="index-2.html"><img src="files/images/logo.png" alt=""></a>
								<span class="header">
									Ks interior design...;jsc
								</span>
							</div>
							<div class="search">
					...
					<div class="container-fluid">
						<nav class="nav navbar-inverse navbar-fixed-top main-navigation hidden-xs hidden-sm" id="myH2">
							<ul>
								...
								<li><a href="blog-single.html">Sản Phẩm Thông Minh</a></li>
								...
								<li><a href="about.html">Công Trình Hoàn Thiện</a></li>
								...
								<li><a href="cau-thang.html">Dịch Vụ Sửa Nhà</a></li>
				...
				<section class="page-heading wow fadeIn" data-wow-duration="1.5s">
					<div class="container">
						<ol class="breadcrumb">
							...
							<li class="active">Công Trình Hoàn Thiện</li>
						</ol>
					</div>
				</section>
							...
							<div class="col-md-12">
								<div class="blog-single-item">
									...
									<div class="blog-single-content">	
										<h3><a href="#">Công Trình Hoàn Thiện</a></h3>
				...
				<footer class="footer">
				      ...
				      <div class="row">
				        ...
				        <div class="address col-md-6">
				        	<p>
				        		Contact :  531 Trương Định ,Hoàng Mai ,Hà Nội
				        	</p>
				        	<p>
				        		Phone Number : 04-6259-7009/ 093-454-479/ 096-5555-966
				        	</p>
				        	<p>
				        		Email : noithatks07@gmail.com/ website : noithatks.com
				        	</p>
				        </div>
				        <div class="col-md-3">
				          <h4>Email updates</h4>
	...
	<script type="text/javascript" src="files/js/add-on.js"></script>
