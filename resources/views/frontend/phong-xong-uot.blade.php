...
<head>
	...
	<title>Phòng Xông Hơi Ướt</title>
					...
					<div class="container-fluid">
						<nav class="nav navbar-inverse navbar-fixed-top main-navigation hidden-xs hidden-sm" id="myH2">
							<ul>
								...
								<li><a href="ngoai-that.html" class="has-submenu">Ngoại Thất</a>
									<ul class="sub-menu">
				...
				<section class="page-heading wow fadeIn" data-wow-duration="1.5s">
					<div class="container">
						<ol class="breadcrumb">
							...
							<li class="active">Phòng Xông Hơi Ướt</li>
						</ol>
					</div>
				</section>
							...
							<div class="col-md-12">
								<div class="blog-single-item">
									...
									<div class="blog-single-content">	
										<h3><a href="phong-xong-uot.html">Phòng Xông Hơi Ướt</a></h3>
